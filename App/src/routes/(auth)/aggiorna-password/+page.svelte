<script>
    ...
    import { validatePassword } from '$lib/auth/utilities';
    ...
    let passwordError = "Compila questo campo!", showSuccess, formError;
        ...
        {:else}
            <form bind:this={form} novalidate>
                ...
                <div class="form-group">
                    ...
                    <InputGroup bind:input={password} type="password" placeholder="Password" minlength="6" class="mb-3">
